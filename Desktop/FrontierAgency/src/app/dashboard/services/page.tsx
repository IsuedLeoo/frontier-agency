...
export default async function DashboardServicesPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Platform management and community engagement",
    },
  ];
    ...
    <div className="max-w-[1200px] mx-auto">
            ...
            >
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    <Users size={14} className="text-[#C5A55A] mt-0.5" />
                    <div className="text-sm text-[#888888]">
                      Assigned team: 3 members
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
      ...
      {services.length === 0 && (
        <div className="reveal bg-black p-12 rounded-xl border border-[#333333] text-center">
          <Package size={32} className="mx-auto mb-4 text-[#333333]" />
          <h2 className="text-lg font-semibold tracking-tight mb-3">
            No services yet
          </h2>
          <p className="text-sm text-[#888888] max-w-[320px]">
            Subscribe to a service to see it appear here.
          </p>
          <Link
            href="/dashboard/services/new"
