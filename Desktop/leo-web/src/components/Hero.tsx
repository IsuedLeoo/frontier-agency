...
export default function Hero() {
  return (
    <section className="min-h-screen flex flex-col justify-center items-center px-6 md:px-12 text-center relative">
      ...
      <p
        className="reveal text-sm sm:text-base md:text-lg font-light text-[#888888] max-w-[600px] leading-relaxed mb-8 sm:mb-10 md:mb-12"
      ...
      <div className="reveal flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 mb-8 sm:mb-10">
      ...
      <div className="reveal flex flex-col sm:flex-row gap-4 sm:gap-4 w-full sm:w-auto items-center justify-center">
        <a
          href="#pricing"
